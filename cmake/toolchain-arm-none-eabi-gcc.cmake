...
set(TOOLCHAIN_ARCHIVE_DIR ${CORAL_MICRO_SOURCE_DIR}/third_party/toolchain-tmp)

if (${CMAKE_HOST_WIN32})
    set(TOOLCHAIN_DIR ${CORAL_MICRO_SOURCE_DIR}/third_party/toolchain-win)
    set(TOOLCHAIN_PREFIX "arm-gnu-toolchain-12.3.rel1-mingw-w64-i686-arm-none-eabi")
    set(TOOLCHAIN_ARCHIVE toolchain-win.zip)
    set(TOOLCHAIN_EXE_EXTENSION ".exe")
    set(TOOLCHAIN_URL "https://developer.arm.com/-/media/Files/downloads/gnu/12.3.rel1/binrel/${TOOLCHAIN_PREFIX}.zip")
elseif(${CMAKE_HOST_APPLE})
    set(TOOLCHAIN_DIR ${CORAL_MICRO_SOURCE_DIR}/third_party/toolchain-mac)
    set(TOOLCHAIN_ARCHIVE toolchain-mac.tar.xz)
    set(TOOLCHAIN_EXE_EXTENSION "")
    if(CMAKE_HOST_SYSTEM_PROCESSOR STREQUAL "arm64")
        set(TOOLCHAIN_PREFIX "arm-gnu-toolchain-12.3.rel1-darwin-arm64-arm-none-eabi")
        set(TOOLCHAIN_URL "https://developer.arm.com/-/media/Files/downloads/gnu/12.3.rel1/binrel/${TOOLCHAIN_PREFIX}.tar.xz")
    else()
        set(TOOLCHAIN_PREFIX "arm-gnu-toolchain-12.3.rel1-darwin-x86_64-arm-none-eabi")
        set(TOOLCHAIN_URL "https://developer.arm.com/-/media/Files/downloads/gnu/12.3.rel1/binrel/${TOOLCHAIN_PREFIX}.tar.xz")
    endif()
else() # Linux
    set(TOOLCHAIN_DIR ${CORAL_MICRO_SOURCE_DIR}/third_party/toolchain-linux)
    set(TOOLCHAIN_PREFIX "arm-gnu-toolchain-12.3.rel1-x86_64-arm-none-eabi")
    set(TOOLCHAIN_ARCHIVE toolchain-linux.tar.xz)
    set(TOOLCHAIN_EXE_EXTENSION "")
    set(TOOLCHAIN_URL "https://developer.arm.com/-/media/Files/downloads/gnu/12.3.rel1/binrel/${TOOLCHAIN_PREFIX}.tar.xz")
endif()
...
if (NOT EXISTS ${TOOLCHAIN_DIR})
    ...
    file(DOWNLOAD ${TOOLCHAIN_URL} ${TOOLCHAIN_ARCHIVE_DIR}/${TOOLCHAIN_ARCHIVE})
    message(STATUS "Extracting ${TOOLCHAIN_ARCHIVE_DIR}/${TOOLCHAIN_ARCHIVE} to ${TOOLCHAIN_ARCHIVE_DIR}")
    file(ARCHIVE_EXTRACT INPUT ${TOOLCHAIN_ARCHIVE_DIR}/${TOOLCHAIN_ARCHIVE} DESTINATION ${TOOLCHAIN_ARCHIVE_DIR})
    message(STATUS "Moving ${TOOLCHAIN_ARCHIVE_DIR}/${TOOLCHAIN_PREFIX} to ${TOOLCHAIN_DIR}")
    file(RENAME ${TOOLCHAIN_ARCHIVE_DIR}/${TOOLCHAIN_PREFIX} ${TOOLCHAIN_DIR})
    message(STATUS "Removing ${TOOLCHAIN_ARCHIVE_DIR}")
    file(REMOVE_RECURSE ${TOOLCHAIN_ARCHIVE_DIR})
endif()
get_filename_component(CMAKE_AR ${TOOLCHAIN_DIR}/bin/arm-none-eabi-ar${TOOLCHAIN_EXE_EXTENSION} REALPATH CACHE)
get_filename_component(CMAKE_C_COMPILER ${TOOLCHAIN_DIR}/bin/arm-none-eabi-gcc${TOOLCHAIN_EXE_EXTENSION} REALPATH CACHE)
get_filename_component(CMAKE_CXX_COMPILER ${TOOLCHAIN_DIR}/bin/arm-none-eabi-g++${TOOLCHAIN_EXE_EXTENSION} REALPATH CACHE)
get_filename_component(CMAKE_OBJCOPY ${TOOLCHAIN_DIR}/bin/arm-none-eabi-objcopy${TOOLCHAIN_EXE_EXTENSION} REALPATH CACHE)
get_filename_component(CMAKE_STRIP ${TOOLCHAIN_DIR}/bin/arm-none-eabi-strip${TOOLCHAIN_EXE_EXTENSION} REALPATH CACHE)
