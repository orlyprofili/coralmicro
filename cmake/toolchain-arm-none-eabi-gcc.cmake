...
set(TOOLCHAIN_TMP_DIR ${CORAL_MICRO_SOURCE_DIR}/third_party/toolchain-tmp)
set(TOOLCHAIN_PREFIX "")

if (${CMAKE_HOST_WIN32})
    set(TOOLCHAIN_DIR ${CORAL_MICRO_SOURCE_DIR}/third_party/toolchain-win)
    set(TOOLCHAIN_TMP_PREFIX "arm-gnu-toolchain-12.3.rel1-mingw-w64-i686-arm-none-eabi")
    set(TOOLCHAIN_ARCHIVE toolchain-win.zip)
    set(TOOLCHAIN_EXE_EXTENSION ".exe")
    set(TOOLCHAIN_URL "https://developer.arm.com/-/media/Files/downloads/gnu/12.3.rel1/binrel/${TOOLCHAIN_TMP_PREFIX}.zip")
elseif(${CMAKE_HOST_APPLE})
    ...
    if(CMAKE_HOST_SYSTEM_PROCESSOR STREQUAL "arm64")
        set(TOOLCHAIN_TMP_PREFIX "arm-gnu-toolchain-12.3.rel1-darwin-arm64-arm-none-eabi")
        set(TOOLCHAIN_URL "https://developer.arm.com/-/media/Files/downloads/gnu/12.3.rel1/binrel/${TOOLCHAIN_TMP_PREFIX}.tar.xz")
    else()
        set(TOOLCHAIN_TMP_PREFIX "arm-gnu-toolchain-12.3.rel1-darwin-x86_64-arm-none-eabi")
        set(TOOLCHAIN_URL "https://developer.arm.com/-/media/Files/downloads/gnu/12.3.rel1/binrel/${TOOLCHAIN_TMP_PREFIX}.tar.xz")
    endif()
else() # Linux
    set(TOOLCHAIN_DIR ${CORAL_MICRO_SOURCE_DIR}/third_party/toolchain-linux)
    set(TOOLCHAIN_TMP_PREFIX "arm-gnu-toolchain-12.3.rel1-x86_64-arm-none-eabi")
...
if (NOT EXISTS ${TOOLCHAIN_DIR})
    ...
    file(DOWNLOAD ${TOOLCHAIN_URL} ${TOOLCHAIN_TMP_DIR}/${TOOLCHAIN_ARCHIVE})
    message(STATUS "Extracting ${TOOLCHAIN_TMP_DIR}/${TOOLCHAIN_ARCHIVE} to ${TOOLCHAIN_TMP_DIR}")
    file(ARCHIVE_EXTRACT INPUT ${TOOLCHAIN_TMP_DIR}/${TOOLCHAIN_ARCHIVE} DESTINATION ${TOOLCHAIN_TMP_DIR})
    message(STATUS "Moving ${TOOLCHAIN_TMP_DIR}/${TOOLCHAIN_TMP_PREFIX} to ${TOOLCHAIN_DIR}")
    file(RENAME ${TOOLCHAIN_TMP_DIR}/${TOOLCHAIN_TMP_PREFIX} ${TOOLCHAIN_DIR})
    message(STATUS "Removing ${TOOLCHAIN_TMP_DIR}")
    file(REMOVE_RECURSE ${TOOLCHAIN_TMP_DIR})
endif()
